...
DATA_PATH = "c:/Users/Matteo/Desktop/cvcs/storage/MOTChallenge/MOT17"
OUT_PATH = "c:/Users/Matteo/Desktop/cvcs/storage/MOTChallenge/motcha_coco_annotations"
...
if __name__ == '__main__':
    ...
    for split in SPLITS:
        ...
        if split == "eval":
            data_path = os.path.join(DATA_PATH, 'eval')
        if split == "train":
