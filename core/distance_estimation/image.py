...
def process(image_path, model_path):
    ...
    saveReportImage(image, grid, warped)
    print("Done!")


def saveReportImage(image, grid, warped):
    ...
    # save figure
    plt.savefig(fname="./report/image/output.png", format="png")
    plt.clf()
