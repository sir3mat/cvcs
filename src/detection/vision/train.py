...
from . import engine
from . import group_by_aspect_ratio as groupAR
...
def get_dataset(name, image_set, transform, data_path):
    paths = {"coco": (data_path, coco_utils.get_coco, 91),
             "coco_kp": (data_path, coco_utils.get_coco_kp, 2)}
...
def main(args):
    ...
    if args.aspect_ratio_group_factor >= 0:
        group_ids = groupAR.create_aspect_ratio_groups(
            dataset, k=args.aspect_ratio_group_factor)
        train_batch_sampler = groupAR.GroupedBatchSampler(
